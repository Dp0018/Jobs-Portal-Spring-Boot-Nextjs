      ...
      <div className="w-full lg:w-2/3 space-y-6">
                  ...
                  {props.endDate && (
                    <>
                      ...
                      <div className="flex items-center gap-1.5 text-destructive font-medium">
                        ...
                        <span>
                          Closes: {new Date(props.endDate).toLocaleDateString()}
                        </span>
                      </div>
                    </>
                  )}
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-lg">
          ...
          <p className="text-muted-foreground text-justify leading-relaxed">
            ...
            accusantium nobis magnam aut laborum commodi natus vero sequi
            aliquam voluptas perspiciatis amet est velit corporis, consequuntur
            dolores dolorum ducimus autem, provident officia, assumenda eos vel
            voluptatem cum. Magnam, excepturi quae?
          </p>
        </div>
      </div>
    );
